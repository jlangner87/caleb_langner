const Connect = () => {
  return (
    <div className="connect">
      <h1 className="page_header">Connect with me</h1>
      <div className="content_block">
        <h1 className="content_header">This is Connect with me content</h1>
      ...
      <div className="content_block2">
        <h1 className="content_header">Some more Connect with me content</h1>
        <p className="content_text">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. In varius
          vehicula tellus, sit amet condimentum nunc suscipit in. Cras varius id
          ante vitae dignissim. Aenean convallis eget enim maximus imperdiet.
